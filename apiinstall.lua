...
local aLabel1 = mainFrame:addLabel():setText("API for Big Screens Installer v.1.0beta")
...
aButton1:onClick(function(self,event,button,x,y)
  if(event=="mouse_click")and(button==1)then
    shell.run('wget https://gist.githubusercontent.com/1Turtle/cc1f6973be9d99647953759e1eaaa759/raw/296458ed839cbd573dcaab6c9a6f4a762aa6e777/chromy.lua')
  end
end)
